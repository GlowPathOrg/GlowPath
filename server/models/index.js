...
var backup = "mongodb+srv://glowpathuser:1f0gCnPMKhYfn5OL@gpcluster.xot4d.mongodb.net/?retryWrites=true&w=majority&appName=GPCluster";
var uri = process.env.MONGODB_URI || backup;
console.log('uri is ', backup);
console.log('backup uri is ');
// Create a MongoClient with a MongoClientOptions object to set the Stable API version
var client = new MongoClient(backup, {
    serverApi: {
